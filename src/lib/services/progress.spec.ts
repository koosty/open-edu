...
import { createMockProgress, createMockCourse } from '$lib/test-utils/firebase-mocks'
...
describe('ProgressService', () => {
	...
	describe('getCourseProgress', () => {
		it('should get user progress for a course successfully', async () => {
			...
			const result = await ProgressService.getCourseProgress('user123', 'course123')
		...
		it('should handle errors when getting progress', async () => {
			...
			await expect(ProgressService.getCourseProgress('user123', 'course123'))
	...
	describe('startLesson', () => {
		...
		it('should throw error if user not enrolled', async () => {
			...
			await expect(ProgressService.startLesson('user123', 'course123', 'lesson456'))
	...
	describe('completeLesson', () => {
		it('should complete a lesson successfully', async () => {
			...
			await ProgressService.completeLesson('user123', 'course123', 'lesson1', 30, 85)
		...
		it('should mark course as completed when all lessons done', async () => {
			...
			await ProgressService.completeLesson('user123', 'course123', 'lesson2', 45)
		...
		it('should update existing completion with better quiz score', async () => {
			...
			await ProgressService.completeLesson('user123', 'course123', 'lesson1', 0, 90)
		...
		it('should not update quiz score if new score is lower', async () => {
			...
			await ProgressService.completeLesson('user123', 'course123', 'lesson1', 0, 75)
		...
		it('should throw error if user not enrolled', async () => {
			...
			await expect(ProgressService.completeLesson('user123', 'course123', 'lesson1'))
				.rejects.toThrow('User not enrolled in course')
		})
	...
	describe('updateQuizAttempt', () => {
		it('should update quiz attempt successfully', async () => {
			...
			await ProgressService.updateQuizAttempt('user123', 'course123', 'lesson1', 85, 30)
		...
		it('should not update score if new attempt is worse', async () => {
			...
			await ProgressService.updateQuizAttempt('user123', 'course123', 'lesson1', 75, 20)
		...
		it('should handle first quiz attempt for lesson', async () => {
			...
			await ProgressService.updateQuizAttempt('user123', 'course123', 'lesson1', 88, 25)
		...
		it('should throw error if user not enrolled', async () => {
			...
			await expect(ProgressService.updateQuizAttempt('user123', 'course123', 'lesson1', 85, 30))
				.rejects.toThrow('User not enrolled in course')
		})
	...
	describe('isLessonCompleted', () => {
		it('should return true for completed lesson', async () => {
			...
			const result = await ProgressService.isLessonCompleted('user123', 'course123', 'lesson1')
	...
	describe('getQuizScore', () => {
		it('should return quiz score for completed lesson', async () => {
			...
			const result = await ProgressService.getQuizScore('user123', 'course123', 'lesson1')
	...
	describe('getProgressSummary', () => {
		it('should return complete progress summary', async () => {
			...
			const result = await ProgressService.getProgressSummary('user123', 'course123')

			expect(result.progress).toEqual(expect.objectContaining({
				id: 'progress-123',
				completedLessons: ['lesson1']
			}))
			expect(result.course).toEqual(expect.objectContaining({
				id: 'course-123'
			}))
			expect(result.nextLesson).toEqual(expect.objectContaining({
		...
		it('should handle summary fetch errors', async () => {
			...
			await expect(ProgressService.getProgressSummary('user123', 'course123'))
	...
	describe('updateActivityStreak', () => {
		...
		it('should handle missing progress gracefully', async () => {
			...
			await expect(ProgressService.updateActivityStreak('user123', 'course123'))
